...
export default function LeftSidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col items-center fixed left-0 top-0 h-screen w-1/4 max-w-xs p-6 z-20">
      <div className="bg-white/80 dark:bg-blue-950/80 rounded-2xl shadow-xl border border-blue-200/60 dark:border-blue-900/60 w-full p-6 mt-24">
        ...
        <nav className="flex flex-col gap-3">
          ...
          <Link href="/settings" className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900 transition font-medium text-gray-800 dark:text-gray-100">
