...
export default function PostMenuBurger({ onEdit, onDelete }) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-200 dark:bg-blue-900 text-gray-700 dark:text-white hover:bg-gray-300 dark:hover:bg-blue-800 shadow transition focus:outline-none"
        aria-label="Ouvrir le menu post"
        onClick={() => setOpen((v) => !v)}
        type="button"
      >
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-40 bg-white dark:bg-blue-950 border border-gray-200 dark:border-blue-900 rounded-xl shadow-lg z-50 animate-fade-in">
          <button
